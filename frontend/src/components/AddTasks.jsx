        ...
        <form onSubmit={handleSubmit} className="bg-white text-black rounded-xl shadow-lg p-8 w-full max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" name="startDate" value={taskData.startDate} onChange={handleChange} className="w-full border rounded p-2 mb-4" />
            </div>
            <div>
          ...
          {!imagePreview ? (
            ...
            <div className="relative mb-6">
              ...
              <div className="absolute top-2 right-2 flex gap-2">
                <button type="button" onClick={handleRemoveImage} className="bg-red-500 text-white px-3 py-1 rounded-lg flex items-center gap-2 hover:bg-red-600">
                  <FaTrash /> Remove
                </button>
          ...
          <div className="flex justify-between items-center">
            <button type="submit" className="bg-blue-500 text-white font-semibold px-6 py-2 rounded hover:bg-blue-600">Post Task</button>
            <button type="button" className="text-gray-600 font-semibold hover:underline">Cancel</button>
          </div>
        </form>
      </div>
    </div>
